...
writeline(headerfile, "class StringNode;")
writeline(headerfile, "")
...
writeline(headerfile, "  long long base_int;")
...
writeline(headerfile, "  virtual void visitStringNode(StringNode* node) = 0;")
writeline(headerfile, "};")
writeline(headerfile, "")
...
writeline(headerfile, "};")
writeline(headerfile, "")
writeline(headerfile, "// Integers have a member value, which is a C long long")
writeline(headerfile, "class IntegerNode : public ASTNode {")
writeline(headerfile, "public:")
writeline(headerfile, "  long long value;")
writeline(headerfile, "")
writeline(headerfile, "  virtual void visit_children(Visitor* v) {/* No Children */ }")
writeline(headerfile, "  virtual void accept(Visitor* v) { v->visitIntegerNode(this); }")
writeline(headerfile, "")
writeline(headerfile, "  IntegerNode(long long value) { this->value = value; }")
writeline(headerfile, "};")
writeline(headerfile, "")
writeline(headerfile, "// Strings have a member value, which is a C++ string")
writeline(headerfile, "class StringNode : public ASTNode {")
writeline(headerfile, "public:")
writeline(headerfile, "  std::string value;")
writeline(headerfile, "")
writeline(headerfile, "  virtual void visit_children(Visitor* v) {/* No Children */ }")
writeline(headerfile, "  virtual void accept(Visitor* v) { v->visitStringNode(this); }")
writeline(headerfile, "")
writeline(headerfile, "  StringNode(char *value) { this->value = std::string(value); }")
writeline(headerfile, "};")
writeline(headerfile, "")
...
writeline(headerfile, "  virtual void visitStringNode(StringNode *node);")
writeline(headerfile, "};")
...
writeline(codefile, "}")
writeline(codefile, "")
writeline(codefile, "void Print::visitStringNode(StringNode* node) {")
writeline(codefile, "  // Print the value of the string")
writeline(codefile, "  this->addElement(node->value);")
writeline(codefile, "  node->visit_children(this);")
writeline(codefile, "}")
writeline(codefile, "")
